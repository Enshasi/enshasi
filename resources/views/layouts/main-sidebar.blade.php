        ...
        <div class="side-menu-fixed">
            <div class="scrollbar side-menu-bg" style="overflow: scroll">
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li class="mt-10 mb-10 text-muted pl-4 font-medium menu-title">{{trans('')}} </li>
                    ...
                    <li>
                        ...
                        <ul id="classes-menu" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{URL('classrooms/index')}}">{{trans('main_trans.List_classes')}}</a></li>
                        </ul>
                    </li>
                        ...
                        <ul id="students-menu" class="collapse">
                            <li>
                                ...
                                <ul id="Student_information" class="collapse">
                                    <li> <a href="{{url('student/create')}}">{{trans('main_trans.add_student')}}</a></li>
                                    <li> <a href="{{url('student/index')}}">{{trans('main_trans.list_students')}}</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul id="Students_upgrade" class="collapse">
                                    <li> <a href="{{url('students/Promotions')}}">{{trans('main_trans.add_Promotion')}}</a></li>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#Teachers-menu">
                            <div class="pull-left"><i class="fas fa-chalkboard-teacher"></i></i><span
                                    class="right-nav-text">{{trans('main_trans.List_Teachers')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
...
{{--                            <li> <a href="{{url('add_parent')}}">{{trans('main_trans.Add_Parent')}}</a> </li>--}}
                    ...
                    <li>
                        ...
                        <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
                            ...
                            <li> <a href="{{url('receipt_students/index')}}">سندات القبض</a> </li>
                            <li> <a href="{{url('ProcessingFee/index')}}">استبعاد رسوم </a> </li>
                            <li> <a href="{{url('Payment/index')}}">سند صرف</a> </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="Attendance-icon" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{url('Attendance/index')}}">قائمة الحضور والغياب</a> </li>
                    ...
                    <li>
                        ...
                        <ul id="Subjects" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{url('Subject/index')}}">قائمة المواد</a> </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="Exams-icon" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{url('Quizzes/index')}}">قائمة الأختبارات</a> </li>
                            <li> <a href="{{url('Questions/index')}}">قائمة الاسئلة</a> </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="library-icon" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ url('library/index') }}">قائمة الكتب</a> </li>
...
{{--                            <li> <a href="{{url('Online_classes/index')}}">حصص أونلاين على زوم</a> </li>--}}
{{--                            <li> <a href="">الأتصال المباشر مع زوم</a> </li>--}}
{{--                        </ul>--}}
{{--                    </li>--}}
                    ...
                    <!-- Settings-->
                    <li>
                        <a href="{{url('settings/index')}}"><i class="fas fa-cogs"></i><span class="right-nav-text">{{trans('main_trans.Settings')}} </span></a>
                    </li>
