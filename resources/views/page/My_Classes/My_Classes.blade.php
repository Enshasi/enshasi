            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <br><br>
                        ...
                        <form action="{{ URL('Classroom/Filter_Classes') }}" method="POST">
                            @csrf
                    ...
                    <div class="table-responsive">
                        <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                            ...
                            <thead>
                            <tr>
                                <td><input name="select_all" id="example-select-all" type="checkbox" onclick ="checkAll('box1' , this)"/></td>
                                <th>#</th>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="{{URL('Classrooms/update') }}" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        <label
                                                            for="exampleFormControlTextarea1">{{ trans('grades_trans.Name') }}
                                                            :</label>

                                                        <select  class="form-control" id="exampleFormControlSelect2" name="Grade_id">
    ...
    <div class="modal fade" id="delete_all" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{URL('Classroom/deleteAll')}}"  method="POST">
                    @csrf
                    <div class="modal-body">
