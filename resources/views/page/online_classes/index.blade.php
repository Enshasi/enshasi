            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{url('Online_classes/create')}}" class="btn btn-success btn-sm" role="button"
                                   aria-pressed="true">اضافة حصة جديدة</a>
                                <a class="btn btn-warning btn-sm" href="{{route('indirect.create')}}">اضافة حصة اوفلاين جديدة</a>
                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @include('page.online_classes.delete')
                                        @endforeach
                                    </table>
                                </div>
                            </div>
