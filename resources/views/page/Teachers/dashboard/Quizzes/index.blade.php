                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{route('quizzes.show',$quizze->id)}}"
                                                       class="btn btn-warning btn-sm" title="عرض البيانات "  role="button" aria-pressed="true"><i
                                                    ...
                                                    <form action="{{route('quizzes.destroy',$quizze->id)}}" method="post">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <input type="hidden" name="id" value="{{$quizze->id}}"></div><div class="modal-footer"><div class="modal-footer"><button type="button" class="btn btn-secondary"
